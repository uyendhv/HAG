...
hold on
%for AS-HRT
APX_line1 = plot(data_np1(1,:),'--bo','MarkerEdgeColor','k','MarkerSize',9,'LineWidth',1.7);
...
%
%for HS-HRT
HAG_line1 = plot(data_np2(1,:),'--ro','MarkerEdgeColor','k','MarkerFaceColor','k','MarkerSize',9,'LineWidth',1.7);
