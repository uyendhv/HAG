...
hold on
%for AS-HRT
APX_line1 = plot(APX_plot_data(1,:),'--bd','MarkerEdgeColor','k','MarkerSize',9,'LineWidth',1.7);
...
%
%for HS-HRT - lines
HAG_line1 = plot(HAG_plot_data(1,:),'--rd','MarkerEdgeColor','k','MarkerFaceColor','k','MarkerSize',9,'LineWidth',1.7);
