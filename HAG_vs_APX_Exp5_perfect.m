...
APX_line2 = plot(data_np1(2,:),'-bp','MarkerEdgeColor','k','MarkerSize',9,'LineWidth',1.7);
...
HAG_line2 = plot(data_np2(2,:),'--rp','MarkerEdgeColor','k','MarkerFaceColor','k','MarkerSize',9,'LineWidth',1.7);
...
%=========================================================================
%
 hand = legend([HAG_line1,APX_line1, HAG_line2,APX_line2, HAG_line3,APX_line3],...
        'HAG {\it p_1} = 0.97{     }','APX{\it p_1} = 0.97{     }',....
        'HAG {\it p_1} = 0.98{     }','APX{\it p_1} = 0.98{     }',....
        'HAG {\it p_1} = 0.99{     }','APX{\it p_1} = 0.99{     }');     
